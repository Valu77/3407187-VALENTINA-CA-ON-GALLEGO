...
const rawEntityName = "  análisis de cultivo de maíz  ";

const entityCategory = "Servicio agrícola";

const entityCode = "AGR-001";

const entityDescription = "Servicio de asesoría para mejorar la producción de cultivos en el dominio agrícola.";

const mainValue = 50000;
...
const descriptionIsRelevant = entityDescription.includes("cultivo");
...
console.log(`¿Descripción contiene 'cultivo'?: ${descriptionIsRelevant}`);
